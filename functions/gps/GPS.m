...
%
% Changelog:
% 2013.04.05 - copy of the home GPS1.8/GPS function so that it can be opened up later.
...
set(state.gui.analysis, 'Callback', ['GPSa; delete(' num2str(state.gui.fig) ');']);
...
set(state.gui.editor, 'Callback', ['GPSe; delete(' num2str(state.gui.fig) ');']);
...
set(state.gui.regionator, 'Callback', ['GPS_rois; delete(' num2str(state.gui.fig) ');']);
...
set(state.gui.plot, 'Callback', ['GPSp; delete(' num2str(state.gui.fig) ');']);

function smooth_value = gps_brain_smoothdata(value, faces, vertex)
...
% 2012.06.26 - Created as GPS1.6(-)/rois_metrics_smooth.m
...
for tt = 1:size(value, 2)
	...
	for i_smoothing = 1:N_smoothings %#ok<ALIGN>
		w = B * w ./ yy;

function plot_data_rois(GPSP_vars)
...
%
% Changelog:
% 2012-07-17 Created, based off of plot_data_granger
% 2012-10-11 Loosely adapted to GPS1.7
% 2013-07-09 GPS1.8 Changed how it loads the information

hObject = GPSP_vars.data_granger_load;

set(GPSP_vars.data_granger_load, 'String', 'Loading');

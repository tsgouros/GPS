function gpsp_draw_surf
% Draws a cortical or circular surface with a granger overlay
%
% Author: A. Conrad Nied (conrad.logos@gmail.com)
% 
% Changelog:
% 2012-07-05 Made from granger_plot_draw as GPS1.6/plot_draw.m
% 2012-10-11 Loosely adapted to GPS1.7
% 2013-02-11 Remakes axis if it was deleted
% 2013-07-15 Starting the overhaul to GPS1.8/gpsp_draw_surf. Prepares
% images to be opened by other programs as opposed to doing it all.
% 2013-08-05 Changed the no button

state = gpsp_get;

if(get(state.surf_cort, 'Value'))
    gpsp_draw_cort;
elseif(get(state.surf_circle, 'Value'))
    gpsp_draw_circle;
end

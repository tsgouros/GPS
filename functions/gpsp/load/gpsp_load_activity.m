...
state = gpsp_get;
set(state.data_act_load, 'String', 'Loading');
set(state.data_act_load, 'FontWeight', 'Normal');
set(state.data_act_load, 'FontAngle', 'Italic');
guidata(state.data_act_load, state);

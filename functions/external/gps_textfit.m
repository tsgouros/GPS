function h = gps_textfit(x,y,z,txt,varargin)
% textfit(x,y,txt,varargin)
%
% Mike Lawrence 2011
% Adapted to GPS1.8 by Conrad Nied 2013.05.30
...
for t = 1:maxtries
    ...
    for i=1:length(o1), i1=o1(i); i2=o2(i);
        ...
        if oy/ytot < ox/xtot & pos1(2)+1 < yl & pos2(2)+1 < yl & pos1(2)>1 & pos2(2) > 1 % overlapy is easier to fix
            ...
            if xstart(i1)<xstart(i2)  % i1 left of i2
                pos1(3)=pos1(3)-shift; pos2(3)=pos2(3)+shift;
            else                      % i1 right of i2
                pos1(3)=pos1(3)+shift; pos2(3)=pos2(3)-shift;
            end
        end

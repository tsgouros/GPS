...
\dataflow{BE model}{}{.surf files in MRI/subject/bem, and in
  MRI/subject/bem/watershed} Boundary element model.  Find boundary to brain,
  differentiate with skull.  Invokes \verb+mri_watershed+

\dataflow{BE model to fif}{}{fif files in MRI/subject/bem} -- Convert
model to fif file, nothing more? 
  Invokes \verb+mne_prepare_bem_model+.

\dataflow{Average surface}{files in MRI/subject/surf/}%
...
\dataflow{Import}{raw fif files somewhere}{MEG/subject/scans}
...
\dataflow{Extract events}{MEG/subject/scans}{MEG/subject/events/*.eve} 
...
\dataflow{Process events}{MEG/subject/events/*.eve}{MEG/subject/events/*grouped.eve}  DO NOT USE use.
...
\dataflow{Bad channels}{text dialog}{MEG/subject/subject-bad-channels.txt}
  ...
  browse raw' step   to note which channels are bad, write them down, and note
  them here.  The channel numbers look like this: \verb+EEG1234+ and
  \verb+MEG1234+. 
...
\dataflow{Average waves}{MEG/subject/events/*grouped*}{MEG/subject/scans\_filtered, also look in
  MNE/subject/blocks, and MNE/subject\_ave.fif,subject\_cov.fif} --
...
\dataflow{Forward solution}{}{MNE/subject/subject-fwd.fif}  Requires
co-registration step from the MEG menu.

\dataflow{Inverse solution}{}{MNE/subject/subject\_meg-inv.fif and MNE/subject/subject\_meg\_eeg-inv.fif} -- creates *.inv.fif files.
...
\dataflow{mne\_browse\_raw}{}{fif file, by default goes in MEG/subject/scans}

\dataflow{mne\_analyze}{raw fif, also inflated
  brain}{MRI/subject/mri/T1-neuromag/sets} 
